<?php
class Header{
   function __construct(String $title, String $libs_dir, String $index, String $home) { 
   echo <<<HTML
   <!-- Integrations -->
   <head>
      <meta charset="UTF-8">
   ...
   <body data-bs-theme="dark">
      <div class="container">
         <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <li class="nav-item"><a href="{$index}../Test/viewDB.php" class="nav-link">Database View</a></li>
            <li class="nav-item"><a href="{$index}" class="nav-link active me-2" aria-current="page">Opciones TP</a></li>
            <li class="nav-item"><a href="{$home}" class="nav-link active me-2" aria-current="page">Home</a></li>
         </ul>
         </header>
      </div>
