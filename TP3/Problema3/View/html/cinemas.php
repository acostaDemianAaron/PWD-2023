...
<body>
    <div class="container">
        <form id="form-peliculas" name="form-peliculas" action="aCinemas.php" method="POST" novalidate enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="imagen" class="form-label">Poster de la Película</label>
