            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow-lg p-3 mb-5 bg-white ">
                        ...
                        <div class="card-body">
                            <form action="action/aHsCursadas.php" method="GET" id="form_control" name="form_control">
                                <div class="form-row">

                                    <div class="mb-3">

                                        <div class="mb-3" style="color:black;">Lunes</div>
                                        <input id="lunes" name="lunes" type="time" class="form-control">

                                        <div class="mb-3" style="color:black;">Martes</div>
                                        <input id="martes" name="martes" type="time" class="form-control">

                                        <div class="mb-3" style="color:black;">Miercoles</div>
                                        <input id="miercoles" name="miercoles" type="time" class="form-control">

                                        <div class="mb-3" style="color:black;">Jueves</div>
                                        <input id="jueves" name="jueves" type="time" class="form-control">

                                        <div class="mb-3" style="color:black;">Viernes</div>
                                        <input id="viernes" name="viernes" type="time" class="form-control">
